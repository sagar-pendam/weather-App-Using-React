    ...
    return (
        ...
        transition={{
            ...
            {setdailyWeatherReportDt.length >0 ?(dailyWeatherReportDt.map((data,index)=>{
              return  <li key={index} className='border gap-4 scroll-smooth sm:gap-1 text-white bg-slate-800 px-4 py-2 rounded-md flex items-center justify-around overflow-y-auto overflow-x-scroll sm:overflow-x-auto  text-[10px] sm:text-sm'>
